    ...
    <div className="min-h-screen bg-[#0a0a0a] pt-8 pb-16">
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            <div className="text-xs uppercase tracking-widest font-['Share_Tech_Mono']" style={{ color: statusColor, opacity: 0.7 }}>
              {provider}
            </div>
            <h1 className="text-2xl font-semibold text-[#f5f5f5] mt-1 font-['Share_Tech_Mono']">{modelName}</h1>
          ...
          <div className="text-right">
            ...
            <div className="text-4xl font-bold font-['Share_Tech_Mono']" style={{ color: statusColor }}>
              {model.bsi.toFixed(1)}
            </div>
